...
const EMPTY_METRICS = {
  ignite_enrollment: 0,            propel_enrollment: 0,           accelerate_enrollment: 0,
  stream_ignite_to_propel: 0,      stream_propel_to_accelerate: 0,
  career_ignite_enrollment: 0,     career_propel_enrollment: 0,
  career_accelerate_enrollment: 0, career_captains_enrollment: 0,
  career_ignite_to_propel: 0,      career_propel_to_accelerate: 0,
  career_accelerate_to_captains: 0,
  abroad_enrolled: 0,              abroad_applications: 0,
  abroad_visa_submissions: 0,      abroad_visa_approvals: 0,
...
function buildDisplayData(raw) {
  ...
  return {
    ...
    programsFoundation: [
      { tier: "foundation", badge: "Foundation", icon: "ignite",
        name: "Ignite",     tagline: "Early-stage orientation",  enrollment: m.ignite_enrollment },
      { tier: "core",       badge: "Core",       icon: "propel",
        name: "Propel",     tagline: "Career acceleration",      enrollment: m.propel_enrollment },
      { tier: "strategic",  badge: "Strategic",  icon: "accelerate",
        name: "Accelerate", tagline: "Global leadership",        enrollment: m.accelerate_enrollment },
    ],
    stepsFoundation: [
      { label: "IGNITE TO PROPEL",      sub: "Retention: High", pct: m.stream_ignite_to_propel },
      { label: "PROPEL TO ACCELERATE",  sub: "Target Met",      pct: m.stream_propel_to_accelerate },
    ],

    // SERVICE 2 — Career Coaching programs
    programs: [
      { tier: "foundation", badge: "Foundation", icon: "ignite",
        name: "Ignite",        tagline: "Early-stage orientation", enrollment: m.career_ignite_enrollment },
      { tier: "core",       badge: "Core",       icon: "propel",
        name: "Propel",        tagline: "Career acceleration",     enrollment: m.career_propel_enrollment },
      { tier: "strategic",  badge: "Strategic",  icon: "accelerate",
        name: "Accelerate",    tagline: "Global leadership",       enrollment: m.career_accelerate_enrollment },
      { tier: "elite",      badge: "Elite",      icon: "captains",
        name: "Captains Club", tagline: "Executive network",       enrollment: m.career_captains_enrollment },
    ],
    steps: [
      { label: "IGNITE TO PROPEL",         sub: "Retention: High",   pct: m.career_ignite_to_propel },
      { label: "PROPEL TO ACCELERATE",     sub: "Target Met",        pct: m.career_propel_to_accelerate },
      { label: "ACCELERATE TO CAPTAINS",   sub: "Exclusive Growth",  pct: m.career_accelerate_to_captains },
    ],

    // SERVICE 3 — Study Abroad
    studyAbroad: [
      { enrollmentTag: "Total Enrollment",       name: "Students Enrolled",
        tagline: "Real students who trusted us — no inflated numbers",
        enrollment: m.abroad_enrolled },
      { enrollmentTag: "Total Submission",       name: "Applications Submitted",
        tagline: "Applications submitted by our team — total across countries & courses",
        enrollment: m.abroad_applications },
      { enrollmentTag: "Total Visa Submission",  name: "Visa Files Submitted",
        tagline: "Visa files submitted with complete documentation",
        enrollment: m.abroad_visa_submissions },
      { enrollmentTag: "Total Approval",         name: "Visa Approvals",
        tagline: "Approved visas — updated only after official confirmation",
        enrollment: m.abroad_visa_approvals },
      { enrollmentTag: "Total Rejection",        name: "Visa Rejections",
        ...
        enrollment: m.abroad_visa_rejections },
      {
        ...
        enrollment: m.abroad_visa_submissions
          ? ((m.abroad_visa_approvals / m.abroad_visa_submissions) * 100).toFixed(1) + "%"
          : "—",
      },
    ],
  };
...
export default function ImpactPage() {
  ...
  const { programsFoundation, stepsFoundation, programs, steps, studyAbroad } = display;
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.mgtmconsultancy.com/real-metrics" />
        <meta property="og:title" content="Real Metrics & Student Impact | MGTM Consultancy LLP" />
        ...
        <meta property="og:url" content="https://www.mgtmconsultancy.com/real-metrics" />
        <meta property="og:image" content="https://www.mgtmconsultancy.com/og-impact.jpg" />
        <meta property="og:image:alt" content="MGTM Consultancy LLP Real Metrics and Student Impact" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="MGTM Consultancy LLP" />
        <meta property="og:locale" content="en_IN" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Real Metrics & Impact | MGTM Consultancy LLP" />
        <meta name="twitter:description"
          content="Transparent reporting of student outcomes, visa approvals, and education impact." />
        <meta name="twitter:image" content="https://www.mgtmconsultancy.com/og-impact.jpg" />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Report",
            name: "MGTM Consultancy LLP Real Metrics",
            description: "Publicly available student impact and outcome metrics published by MGTM Consultancy LLP.",
            publisher: {
